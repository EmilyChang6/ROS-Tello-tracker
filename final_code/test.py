...
class bt_mission:
    ...
    def __init__(self):
	   ...
	   | (self.isReceivePass >> self.doAddSp >> self.doHover) >> ((self.isReceiveTag  >> self.doTurnleft >> self.isReceiveTag >> self.doBtStop)  | (self.doComputeData >> (self.isForward >> self.doForward) | (self.doCorrection)))
